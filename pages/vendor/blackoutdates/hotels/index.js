        ...
        <StyledContainer square >
            ...
            <Grid  item xs={12}  sx={{textAlign:'left'}}>
                ...
                (<Grid item xs={12} sm={6} md={4} sx={{textAlign:'center'}}>
                    {console.log(data)}
                <HotelCard name={element.hotelname} startingPrice={element.starting_price} images={element.images} buttonText={'Add blackout dates'} clickFunction={() => router.push({pathname:`/vendor/blackoutdates/hotels/${element.id}`})} /> </Grid>)):''}
                </Grid>
        </StyledContainer>
    );
}

        ...
        return (
          <>
            ...
            <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
              ...
              <MenuItem
                onClick={() => {
                  router.push(`/vendor/editroom/${params.row.roomId}`);
                }}
              >
                Edit
              </MenuItem>
...
AllRooms.getLayout = function getLayout(AllRooms) {
  return <VendorLayout>{AllRooms}</VendorLayout>;
};

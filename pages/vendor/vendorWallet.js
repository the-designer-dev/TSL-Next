...
function VendorWallet() {
  ...
  return (
    <StyledContainer>
      ...
      <UniversalModal open={open} setOpen={setOpen} children={<>
        <Typography fontWeight={500} variant='h6' color={"#555C63"} margin="0px 0px 20px 0px">How much do you like to withdraw? <br /> Amount Rs <span style={{ color: '#2AB572' }}>{remainingAmount}</span></Typography>
        <StyledTextField InputLabelProps={{ shrink: false }}
          label="" type='number' onChange={handleWithdrawChange} />
        <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center", marginTop: "20px" }}>
          <StyledButtonDanger style={{ marginRight: "20px", color: "#fff" }} onClick={() => { setOpen(false) }}>Cancel</StyledButtonDanger>

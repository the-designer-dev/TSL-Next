...
export default function Home() {
  ...
  useEffect(() => {
    setOptions(
      citiesArr.filter((el) =>
        el.toLowerCase().includes(destination.toLowerCase())
      )
    );
  }, [destination]);
                      ...
                      <FormControl fullWidth variant="standard">
                        ...
                        >
                          <Grid container direction="column" spacing={2}>
                            <Grid container item xs={15} direction="column">
                              <Grid
                                sx={{
                                  paddingBottom: "8px",
                                  paddingLeft: "8px",
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <SearchIcon /> Where are you going?
                    </Button>
                  </Box>
                  <MobileMenu
                    open={showMobileMenu}
...
Home.getLayout = function getLayout(Home) {
  return <CustomerLayout2>{Home}</CustomerLayout2>;
};

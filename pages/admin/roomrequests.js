...
function RoomRequests(props) {
    ...
    setRows(
      data.map((el) => {
        return {
          ...
          hotelname: el.hotel.hotelname,
          category: el.roomcategories,
          refundableprice: el.roomrefundprice,
          nonrefundableprice: el.roomnonrefundprice,
        };
      })
    );
  }, []);
  ...
  const columns = [
    ...
    {
      field: "refundableprice",
      headerName: "Price (Refundable)",
      flex: 1,
      headerAlign: "center",
    },
    {
      field: "nonrefundableprice",
      headerName: "Price (Non-Refundable)",
      flex: 1,
      headerAlign: "center",
    },
    {
...
RoomRequests.getLayout = function getLayout(RoomRequests) {
  return <AdminLayout>{RoomRequests}</AdminLayout>;
};

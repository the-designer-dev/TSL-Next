...
export default function RoomFeatures() {
  ...
  function addAmenity(checked, icon, name, description) {
    ...
    else { selectedAmenities = selectedAmenities.filter((el) => { return el.service_name !== name }) }
  ...
  function addFacility(checked, icon, name, description) {
    ...
    else { selectedFacilities = selectedFacilities.filter((el) => { return el.service_name !== name }) }
  ...
  function addIncludes(checked, icon, name, description) {
    ...
    else { selectedIncludes = selectedIncludes.filter((el) => { return el.service_name !== name }) }
    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ backgroundColor: 'button.main' }}>
        <Tabs allowScrollButtonsMobile variant='scrollable' scrollButtons sx={{ '& .MuiTabs-indicator': { height: '5px', backgroundColor: '#FFF' }, '& .MuiTabs-flexContainer': { justifyContent: 'space-between' } }} value={value} onChange={handleChange} aria-label="basic tabs example">
          <Tab sx={{ color: "#FFF", "&.Mui-selected": { color: "#fff" } }} label="Amenities" {...a11yProps(0)} />
          <Tab sx={{ color: "#FFF", "&.Mui-selected": { color: "#fff" } }} label="Facilities" {...a11yProps(1)} />
          <Tab sx={{ color: "#FFF", "&.Mui-selected": { color: "#fff" } }} label="Included" {...a11yProps(2)} />
          <Tab sx={{ color: "#FFF", "&.Mui-selected": { color: "#fff" } }} label="Rules" {...a11yProps(3)} />
          <Tab sx={{ color: "#FFF", "&.Mui-selected": { color: "#fff" } }} label="Custom" {...a11yProps(4)} />
        </Tabs>
      </Box>
            ...
            <Grid container item xs={12}>
              ...
              <Grid item xs={12} sm={6}>
                <StyledTextField InputLabelProps={{ shrink: false }}
                  label="" onChange={(e) => setServiceName(e.target.value)} fullWidth />
              </Grid>
            </Grid>
            <Grid container item xs={12}>
              <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={12} sm={6}>
                <StyledTextField InputLabelProps={{ shrink: false }}
                  label="" onChange={(e) => setserviceDescription(e.target.value)} fullWidth />
              </Grid>
            </Grid>
            <Grid container item xs={12}>
              <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={11} sm={5}>
                <StyledTextField InputLabelProps={{ shrink: false }}
                  label="" placeholder='Search' fullWidth onChange={e => searchIcon(e)} />
              </Grid>
              <Grid item xs={1} sm={1}>

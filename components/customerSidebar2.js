...
function CustomerSidebar(props) {
    ...
    return (
        ...
        <ProSidebar style={{height:'100%',backgroundColor: theme.palette.background.main  , paddingTop:'77px' }} toggled={mobileOpen} collapsed={!mobileOpen} breakPoint='xs'>
            ...
            <Menu iconShape="square">
                ...
                <MenuItem icon={<DirectionsCarFilledOutlinedIcon/>}>Car</MenuItem>

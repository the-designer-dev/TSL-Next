    ...
    >
      ...
      <Typography fontSize={10} fontWight={600} variant='p'>Non-Refundable</Typography>
                ...
                <Grid item xs={18} sx={{lineHeight:'14px'}}>
                    ...
                    <Typography fontSize={12} variant='p'>- asda asd asd asdasd asd</Typography><br/>
                    <Typography fontSize={12} variant='p'>- asda asd asd asdasd asd</Typography><br/>
                    <Typography fontSize={12} variant='p'>- asda asd asd asdasd asd</Typography>
                ...
                <Grid item xs={18} sx={{lineHeight:'14px'}}>
                    <Typography fontSize={12} variant='p'>- asda asd asd asdasd asd</Typography><br/>
                    <Typography fontSize={12} variant='p'>- asda asd asd asdasd asd</Typography><br/>
                    <Typography fontSize={12} variant='p'>- asda asd asd asdasd asdasdasd</Typography>
                </Grid>
                }
                </Grid>
                ...
                <Grid  item xs={18} ><Typography  fontWeight={600} fontSize={12} color='button.main' variant='p'>PKR </Typography><Typography fontWeight={600} fontSize={28} color='button.main' variant='p'>{formats === 'refundable'? el.roomrefundprice : el.roomnonrefundprice}</Typography></Grid>

        ...
        <FormWrapper>
            <form onSubmit={submit}>
                <Grid container spacing={3}>
                    ...
                    <Grid ref={roomDescription} container item spacing={2}>
                    ...
                    <Grid ref={refundableRates} container item spacing={2}>
                        ...
                        <Grid ref={paymentPolicies} item xs={12} >
                            <PaymentPolicies />
                        </Grid>
                    ...
                    <Grid ref={roomQty} container item spacing={1}>

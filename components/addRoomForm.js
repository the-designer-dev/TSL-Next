                            ...
                            <Grid container item spacing={5}>
                                ...
                                <Grid container item spacing={1}>
                                    <Grid item xs={12} sm={12}>
                                        <StyledTextField required label="Full Name Of Room" value={room.roomName} fullWidth onChange={(e) => dispatch(setRoomName(e.target.value))} />
                                    </Grid>
                                </Grid>

                                <Grid container item spacing={1}>
                                    <Grid item xs={12} sm={12}>
                                        <StyledTextField required label="Room No #" fullWidth value={room.roomQuantity} onChange={(e) => dispatch(setRoomQuantity(e.target.value))} type='number' />
                                    </Grid>
                                </Grid>
                                    ...
                                    <Grid item display={"flex"} alignItems={"center"} xs={12} sm={12}>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <StyledTextField required fullWidth InputLabelProps={{ shrink: false }}
                                                label="" value={room.extraBedCapacity.extra_bed_qty} sx={{ '& .MuiInputBase-root': { padding: '0px', '& .MuiInputAdornment-positionStart': { backgroundColor: 'button.main', height: '56px', maxHeight: 'none', borderRadius: '4px 0px 0px 4px', '& .MuiTypography-root': { color: "#FFF" } }, '& .MuiInputAdornment-positionEnd': { backgroundColor: 'button.main', height: '56px', maxHeight: 'none', borderRadius: '0px 4px 4px 0px', '& .MuiTypography-root': { color: "#FFF" } } } }} InputProps={{ startAdornment: <InputAdornment position="start"><Button sx={{ color: "#ffffff" }} onClick={() => { room.extraBedCapacity.extra_bed_qty > 0 ? dispatch(setExtraBedCapacityQuantity(room.extraBedCapacity.extra_bed_qty - 1)) : '' }}>-</Button></InputAdornment>, endAdornment: <InputAdornment position="end"><Button sx={{ color: "#ffffff" }} onClick={() => { dispatch(setExtraBedCapacityQuantity(room.extraBedCapacity.extra_bed_qty + 1)) }}>+</Button></InputAdornment> }} />
                                        </Grid>
                        ...
                        >
                            ...
                            <Grid ref={refundableRates} container item xs={12} spacing={5}>
                                <Grid container item xs={6} spacing={5}>
                                    ...
                                    <Grid item xs={6} ><StyledTextField required InputLabelProps={{ shrink: false }}
                                        label="" value={room.refundableRates} onChange={(e) => dispatch(setRefundableRates(e.target.value))} sx={{ '& .MuiInputBase-root': { padding: '0px', '& .MuiInputAdornment-positionStart': { backgroundColor: 'button.main', height: '56px', maxHeight: 'none', borderRadius: '4px 0px 0px 4px', padding: '0px 10px', '& .MuiTypography-root': { color: "#FFF" } }, '& .MuiInputAdornment-positionEnd': { backgroundColor: 'button.main', height: '56px', maxHeight: 'none', borderRadius: '0px 4px 4px 0px', padding: '0px 10px', '& .MuiTypography-root': { color: "#FFF" } } } }} InputProps={{ startAdornment: <InputAdornment position="start">PKR</InputAdornment>, endAdornment: <InputAdornment position="end">Per Person</InputAdornment> }} fullWidth />
                                    </Grid>
                                    {room.refundablePolicy ?
                                        <Grid container item xs={12} sm={12}>
                                            <Grid item xs={6} sm={6}><Typography variant='p'>Non-Refundable Rates</Typography></Grid>
                                            <Grid item xs={6} sm={6} ><StyledTextField InputLabelProps={{ shrink: false }}
                                                label="" required value={room.nonRefundableRates} onChange={(e) => dispatch(setNonRefundableRates(e.target.value))} sx={{ '& .MuiInputBase-root': { padding: '0px', '& .MuiInputAdornment-positionStart': { backgroundColor: 'button.main', height: '56px', maxHeight: 'none', borderRadius: '4px 0px 0px 4px', padding: '0px 10px', '& .MuiTypography-root': { color: "#FFF" } }, '& .MuiInputAdornment-positionEnd': { backgroundColor: 'button.main', height: '56px', maxHeight: 'none', borderRadius: '0px 4px 4px 0px', padding: '0px 10px', '& .MuiTypography-root': { color: "#FFF" } } } }} InputProps={{ startAdornment: <InputAdornment position="start">PKR</InputAdornment>, endAdornment: <InputAdornment position="end">Per Person</InputAdornment> }} fullWidth />
                                            </Grid>
                                        </Grid>
                                        : ''}
                                </Grid>

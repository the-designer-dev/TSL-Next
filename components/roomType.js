...
function RoomType(props) {
    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            >
                <ToggleButton sx={{ '&.MuiToggleButton-root': { '&.Mui-selected': { backgroundColor: 'button.main', color: "#ffffff" } } }} value="suite" aria-label="bold">
                    <Typography variant='p'>Suite</Typography>
                </ToggleButton>
                <ToggleButton sx={{ '&.MuiToggleButton-root': { '&.Mui-selected': { backgroundColor: 'button.main', color: "#ffffff" } } }} value="executive" aria-label="italic">
                    <Typography variant='p'>Executive Room</Typography>
                </ToggleButton>
                <ToggleButton sx={{ '&.MuiToggleButton-root': { '&.Mui-selected': { backgroundColor: 'button.main', color: "#ffffff" } } }} value="standard" aria-label="italic">

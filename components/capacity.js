        ...
        <Box>
            <Grid container spacing={2}>
                <Grid container item xs={12} sm={6} spacing={1} >
                    ...
                    <StyledTextField fullWidth onChange={(e)=> {e.target.value>=0? dispatch(setChildCapacity(e.target.value)):''}} value={room.childCapacity} sx={{'& .MuiInputBase-root':{padding:'0px' ,'& .MuiInputAdornment-positionStart':{backgroundColor:'button.main' , height:'56px' ,maxHeight:'none' , borderRadius:'4px 0px 0px 4px'  ,'& .MuiTypography-root':{color:"#FFF"}},'& .MuiInputAdornment-positionEnd':{backgroundColor:'button.main' , height:'56px' ,maxHeight:'none' , borderRadius:'0px 4px 4px 0px' ,'& .MuiTypography-root':{color:"#FFF"}}}}}  InputProps={{startAdornment: <InputAdornment position="start"><Button onClick={()=> {room.childCapacity>0? dispatch(setChildCapacity(room.childCapacity - 1)) : ''}}>-</Button></InputAdornment> , endAdornment: <InputAdornment  position="end"><Button onClick={()=> {dispatch(setChildCapacity(Number(room.childCapacity) +1))   }}>+</Button></InputAdornment> }} /></Grid>
                </Grid>
                <Grid container item xs={12} sm={6} spacing={1} >
                    <Grid item xs={12} xs={4}>
                    ...
                    <Grid item xs={12} xs={8}>
                    <StyledTextField fullWidth onChange={(e)=> {e.target.value>=0? dispatch(setAdultCapacity(e.target.value)):''}} value={room.adultCapacity} sx={{'& .MuiInputBase-root':{padding:'0px' ,'& .MuiInputAdornment-positionStart':{backgroundColor:'button.main' , height:'56px' ,maxHeight:'none' , borderRadius:'4px 0px 0px 4px'  ,'& .MuiTypography-root':{color:"#FFF"}},'& .MuiInputAdornment-positionEnd':{backgroundColor:'button.main' , height:'56px' ,maxHeight:'none' , borderRadius:'0px 4px 4px 0px' ,'& .MuiTypography-root':{color:"#FFF"}}}}}  InputProps={{startAdornment: <InputAdornment position="start"><Button onClick={()=> {room.adultCapacity>0? dispatch(setAdultCapacity(room.adultCapacity - 1)) : ''}}>-</Button></InputAdornment> , endAdornment: <InputAdornment  position="end"><Button onClick={()=> {dispatch(setAdultCapacity(Number(room.adultCapacity) +1)) }}>+</Button></InputAdornment> }} /></Grid>
                </Grid>
                <Grid container item xs={12} sm={6} spacing={1} >
                    <Grid item xs={12} xs={4}>
                        <Typography fontWeight={400} variant='p'>Number of Beds:</Typography>
                    </Grid>
                    <Grid item xs={12} xs={8}>

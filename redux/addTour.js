...
export const addTourSlice = createSlice({
	...
	reducers: {
		...
		setDaysLayout: (state, action) => {
			state.daysLayout = action.payload;
		},
		setRatesAdult: (state, action) => {
			state.ratesAdult = action.payload;
		},
		setRatesChild: (state, action) => {
			state.ratesChild = action.payload;
		},
		setRatesInfant: (state, action) => {
			state.ratesInfant = action.payload;
		},
		setStandardRates: (state, action) => {
			state.standardRates = action.payload;
		},
		setVipRates: (state, action) => {
			state.vipRates = action.payload;
		},
		setGuestsShouldBring: (state, action) => {
			state.guestsShouldBring = action.payload;
		},
		setProvidedToGuests: (state, action) => {
			state.providedToGuests = action.payload;
		},
		setProvidedToGuestsOptions: (state, action) => {
			state.providedToGuestsOptions = action.payload;
		},
		setRefundPolicy: (state, action) => {
			state.refundPolicy = action.payload;
		},
		setAdmissionRules: (state, action) => {
			state.admissionRules = action.payload;
		},
	},
});
